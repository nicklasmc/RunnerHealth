      ...
      {isLoading ? (
        <div className="confirm-main-container">
          ...
          <div className="confirm-appt-msg">
            <p className="confirm-appt-msg-cont">
              Thank you {appt.patientFirstName}, your appointment has been
              successfully scheduled!
            </p>
            <p className="confirm-appt-msg-cont">
              A member of our team will reach out to you soon. Please come
              prepared and on time for your appointment.
            </p>
            <p className="confirm-appt-msg-notice">
              <strong>
                <em>
                  If you wish to cancel or reschedule, please contact your
            ...
            <div className="confirm-appt-container">
              <div className="confirm-appt-content">
                <div className="confirm-cell-1">
                  ...
                  <p>
                    <span className="confirm-appt-label">
                      Date/Time Requested:
                    </span>
                    {apptDate} {apptTime}
                  </p>
          ...
          <h2 className="notice">
            Please save this confirmation in the event that you need to
